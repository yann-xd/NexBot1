 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `⫹🗒〚 ᴀʟʟ ᴍᴇɴᴜ 〛`, rowId: ".allmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ sᴇᴍᴜᴀ ᴅᴀғᴛᴀʀ ᴍᴇɴᴜ ʙᴏᴛ"},
	    {title: `⫹🌱 › 𐐪-〚 ʀᴘɢ 〛`, rowId: ".rpgmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʟɪsᴛ ᴍᴇɴᴜ ʀᴘɢ ɢᴀᴍᴇs"},
	{title: `⫹✨ › 〚 ᴇxᴘ 〛`, rowId: ".xpmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴇxᴘ ᴍᴇɴᴜ"},
	{title: `⫹🎮 › 〚 ɢᴀᴍᴇ 〛`, rowId: ".gamemenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʟɪsᴛ ᴍᴇɴᴜ ɢᴀᴍᴇ"},
	{title: `⫹🧩 › 〚 ғᴜɴ 〛`, rowId: ".funmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʟɪsᴛ ᴍᴇɴᴜ ғᴜɴ"},
	{title: `⫹🐚 › 〚 ᴋᴇʀᴀɴɢ 〛`, rowId: ".kerangajaib", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴋᴇʀᴀɴɴ"},
	{title: `⫹📑 › 〚 ǫᴏᴜᴛᴇs 〛`, rowId: ".quotesmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ǫᴏᴜᴛᴇs ᴍᴇɴᴜ"},
	{title: `⫹⛩️ › 〚 ᴀɴɪᴍᴇ 〛`, rowId: ".animemenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴀɴɪᴍᴇᴋ"},
	...
	{title: `⫹☪️ › 〚 ɪsʟᴀᴍɪᴄ 〛`, rowId: ".islamic", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ɪsʟᴀᴍɪᴄ"},
	...
	{title: `⫹🃏 › 〚 sᴛɪᴄᴋᴇʀ 〛`, rowId: ".stikermenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʟɪsᴛ ᴍᴇɴᴜ sᴛɪᴄᴋᴇʀ"},
	{title: `⫹✏️ › 〚 ɴᴜʟɪs 〛`, rowId: ".nulismenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʟɪsᴛ ᴍᴇɴᴜ ɴᴜʟɪs"},
	{title: `⫹🎵 › 〚 ᴀᴜᴅɪᴏ 〛`, rowId: ".audiomenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴀᴜᴅɪᴏ"},
	...
	{title: `⫹🦄 › 〚 ɢʀᴏᴜᴘ 〛`, rowId: ".groupmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʟɪsᴛ ᴍᴇɴᴜ ᴋʜᴜsᴜs ɢʀᴜᴘ"},
	{title: `⫹👑 › 〚 ᴀᴅᴍɪɴ 〛`, rowId: ".adminmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʟɪsᴛ ᴍᴇɴᴜ ᴀᴅᴍɪɴ ɢʀᴜᴘ"},
	{title: `⫹🗃️️ › 〚 ᴅᴀᴛᴀʙᴀsᴇ 〛`, rowId: ".dbmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴅᴀᴛᴀʙᴀsᴇ"},
	{title: `⫹🧰️ › 〚 ᴛᴏᴏʟs 〛`, rowId: ".toolsmenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴛᴏᴏʟs"},
	{title: `️️⫹📊️ › 〚 ɪɴғᴏ 〛`, rowId: ".infomenu", description: "ɪɴғᴏ ᴍᴇɴᴜ"},
	{title: `⫹👩‍💻 › 〚 ᴏᴡɴᴇʀ 〛`, rowId: ".owner", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʟɪsᴛ ᴍᴇɴᴜ ᴏᴡɴᴇʀ"},
	{title: `⫹🎨 › 〚 ᴍᴀᴋᴇʀ 〛`, rowId: ".makermenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴍᴀᴋᴇʀ"},
	{title: `⫹💌 › 〚 sᴛᴏʀᴇ 〛`, rowId: ".storemenu", description: "ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ sᴛᴏʀᴇ"},
	{title: `⫹🔥 › 〚 ᴠɪʀᴛᴇx 〛`, rowId: ".virusmenu", description: "ʟɪsᴛ ᴠɪʀᴛᴇx ᴀɴᴅ ʙᴜɢ"},
	]
    },{
